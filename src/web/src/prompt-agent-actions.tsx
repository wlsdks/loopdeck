...
export function createPromptAgentActionSnapshot(
  ...
  return {
    ...
    actions: [
      {
        id: "mcp-score",
        command: `looprelay:score_prompt prompt_id=${prompt.id} include_suggestions=true`,
      ...
      {
        id: "mcp-improve",
        command: `looprelay:improve_prompt prompt_id=${prompt.id}`,
      ...
      {
        id: "agent-rewrite",
        command: `looprelay:prepare_agent_rewrite prompt_id=${prompt.id} include_local_baseline=true`,
        detail:
      ...
      {
        id: "open-stored",
        command: `looprelay show ${prompt.id} --json`,
