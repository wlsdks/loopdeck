...
- [ ] package files include `dist`, `README.md`, `README.ko.md`, `CHANGELOG.md`, `LICENSE`, `SECURITY.md`, the npm publish preflight script, and core release verification scripts
