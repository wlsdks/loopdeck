...
| `corepack pnpm pack:dry-run`  | PASS   | Built server and web assets, ran the package dry-run wrapper, and produced `promptlane-1.0.0.tgz` with 359 files including this release evidence document.                                                                                                                                                                                                                                                                                                                                  |
