...
Candidate commit `07a3ba86` has a validation-only tarball with the SHA-256
recorded in `reports/independent-user-candidate.json` and a versioned handoff at
`evaluation/usefulness/PARTICIPANT_HANDOFF_07a3ba86.md`. Its isolated maintainer
...
install blocker. It deliberately counts as zero independent humans.
