...
`looprelay` adapters normalize tool-specific hook payloads into one internal event contract.
...
- Hook command: `looprelay hook claude-code`
- Install command: `looprelay install-hook claude-code`

### Codex Beta

- Tool name: `codex`
- Ingest route: `/api/v1/ingest/codex`
- Hook command: `looprelay hook codex`
- Install command: `looprelay install-hook codex`
- Status: beta
