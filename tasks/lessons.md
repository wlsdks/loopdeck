...
- `looprelay` 대시보드 UI는 `/Users/jinan/side-project/oh-my-ontology`의 dark indigo 운영형 디자인 시스템을 1차 기준으로 삼고, AI-looking gradient/glass/neon 스타일을 피한다.
...
- 테스트는 변경 범위와 위험도에 맞춰 최적화한다. 매번 전체 게이트를 기본으로
